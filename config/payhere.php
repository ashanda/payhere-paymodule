...
return [
     ...
     * remember to update api when in production
     * */

    'api_endpoint' => env('PAYHERE_API', 'https://sandbox.payhere.lk'),
    ...
    /*
     * Merchant Secret is specific to each App/Domain.
     * it can be generated for your domain/app as follows
     * https://www.payhere.lk/account/settings/domain-credentials
     ...
     * NOTE: you don't need to generate "Authorization code".
     * it will be automatically generated by this package
